...
def test2():
    ...
    logger.log(3, 'Click on customer login')
    time.sleep(2)
    ...
    harry.click()
    logger.log(3, 'Click on Ron weasly')
    time.sleep(2)
    ...
    transactions.click()
    logger.log(3, 'Click on transactions')
    time.sleep(2)
